...
| `validator.splitvalidator.global.stsAffinity.zoneMode`                              | 'required' (recommended) forces same-zone scheduling — validator pods stay Pending on first install until the statefulset pod is scheduled. 'preferred' favors same-zone but allows fallback.                                                                      | `required`                    |
