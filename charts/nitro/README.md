...
| `jwtSecret.enabled`                          | Enable a jwt secret for use with the stateless validator                        | `true`                                                             |
| `jwtSecret.value`                            | Value of the jwt secret for use with the stateless validator                    | `e3e65b17fcf3f3b109dab33f8bedb388bf5c8003b6615a35c75c016fcec4a91d` |
...
| `validator.defaultNodeSelector.kubernetes.io/arch`                                  | Architecture to schedule the pods to ensure both the stateless validator and nitro node are scheduled on the same architecture. | `arm64`                     |
...
| `validator.splitvalidator.global.metrics`                                           | Enable metrics                                                                                                                  | `false`                     |
| `validator.splitvalidator.global.metrics-server.addr`                               | Address to bind metrics server to                                                                                               | `0.0.0.0`                   |
| `validator.splitvalidator.global.metrics-server.port`                               | Port to bind metrics server to                                                                                                  | `6070`                      |
