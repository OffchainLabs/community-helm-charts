...
| `validator.splitvalidator.global.keda.minReplicas`                                  | Minimum number of replicas                                                                        | `1`                           |
| `validator.splitvalidator.global.keda.maxReplicas`                                  | Maximum number of replicas                                                                        | `10`                          |
| `validator.splitvalidator.global.keda.triggers`                                     | List of triggers for keda                                                                         | `[]`                          |
